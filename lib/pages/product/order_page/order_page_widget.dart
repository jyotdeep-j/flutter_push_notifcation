...
class _OrderPageWidgetState extends State<OrderPageWidget> {
  ...
  void initState() {
    ...
    _model.postalCodeFieldTextController1 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.address, ''));
    _model.postalCodeFieldFocusNode1 ??= FocusNode();

    _model.emailFieldTextController2 ??=
        TextEditingController(text: currentUserEmail);
    _model.emailFieldFocusNode2 ??= FocusNode();

    _model.postalCodeFieldTextController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.address, ''));
    _model.postalCodeFieldFocusNode2 ??= FocusNode();
                                                ...
                                                children: [
                                                  ...
                                                  AuthUserStreamWidget(
                                                    builder: (context) =>
                                                        TextFormField(
                                                      controller: _model
                                                          .postalCodeFieldTextController1,
                                                      focusNode: _model
                                                          .postalCodeFieldFocusNode1,
                                                      autofocus: true,
                                                      autofillHints: const [
                                                                  ...
                                                                  await showDialog<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return AlertDialog(
                                                                            ...
                                                                            content:
                                                                                const Text('Are you sure you want to remove the applied coupon?'),
                                                                            actions: [
                                                                              TextButton(
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            formatNumber(
                                                              functions.calculateTotalAndTax(
                                                                  FFAppState()
                                                                      .cart
                                                                      .toList()),
                                                              formatType:
                                                      ...
                                                      child: FFButtonWidget(
                                                        onPressed: () async {
                                                          ...
                                                          final paymentResponse =
                                                            ...
                                                            context,
                                                            amount: (functions.calculateTotalAndTax(
                                                                        FFAppState()
                                                                            .cart
                                                                            .toList()) *
                                                                    100)
                                                            ...
                                                            description:
                                                                'Purchase of products from Nimbus',
                                                            allowGooglePay:
                                                                true,
                                                            allowApplePay:
                                                                false,
                                                          ...
                                                          if (_model.paymentId !=
                                                            ...
                                                            await actions
                                                              ...
                                                              (item) async {
                                                                ...
                                                                await ItemsRecord.createDoc(_model
                                                                        .orderDoc!
                                                                        .reference)
                                                                    .set(
                                                ...
                                                children: [
                                                  ...
                                                  AuthUserStreamWidget(
                                                    builder: (context) =>
                                                        TextFormField(
                                                      controller: _model
                                                          .postalCodeFieldTextController2,
                                                      focusNode: _model
                                                          .postalCodeFieldFocusNode2,
                                                      autofocus: true,
                                                      autofillHints: const [
                                                        AutofillHints.postalCode
                                                      ],
                                                                      ...
                                                                      return AlertDialog(
                                                                        ...
                                                                        actions: [
                                                                          TextButton(
                                                                            ...
                                                                            child:
                                                                                const Text('Keep Coupon'),
                                                                          ),
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext, true),
                                                                            child:
                                                                                const Text('Remove Coupon'),
                                                                          ),
                                                                        ],
                                                                      );
                                                                    },
                                                          ...
                                                          onPressed: () async {
                                                            await showDialog(
                                                              ...
                                                              builder:
                                                                ...
                                                                safeSetState(() =>
                                                                    _model.couponDataMobile =
                                                                        value));

                                                            _model.coupon = _model
                                                                .couponDataMobile;
                                                            safeSetState(() {});
