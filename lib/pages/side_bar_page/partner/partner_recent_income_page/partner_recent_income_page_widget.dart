...
import 'partner_recent_income_page_model.dart';
export 'partner_recent_income_page_model.dart';

class PartnerRecentIncomePageWidget extends StatefulWidget {
  const PartnerRecentIncomePageWidget({super.key});

  @override
  State<PartnerRecentIncomePageWidget> createState() =>
      _PartnerRecentIncomePageWidgetState();
}

class _PartnerRecentIncomePageWidgetState
    extends State<PartnerRecentIncomePageWidget> {
  late PartnerRecentIncomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PartnerRecentIncomePageModel());
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<ItemsRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<ItemsRecord> partnerRecentIncomePageItemsRecordList =
              snapshot.data!;
                                                    ...
                                                    builder: (dialogContext) {
                                                      return Material(
                                                        ...
                                                        child: GestureDetector(
                                                          ...
                                                          child: FilterWidget(
                                                            items:
                                                                partnerRecentIncomePageItemsRecordList,
                                                          ),
                                                        ),
                                                      );
                                                    },
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                            ...
                                                            .paginatePurchases(
                                                                (_model.date !=
                                                                        ...
                                                                        ? functions.filterItemsByDate(
                                                                            partnerRecentIncomePageItemsRecordList.toList(),
                                                                            _model.date!)
                                                                        : partnerRecentIncomePageItemsRecordList)
                                                                    .toList(),
                                                                _model.page,
                                                                            ...
                                                                            Expanded(
                                                                              child: Text(
                                                                                valueOrDefault<String>(
                                                                                  '#${columnOrdersRecord.id.toString()}',
                                                                                  '#12345678',
                                                                                ),
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      fontFamily: 'Manrope',
                                                    ...
                                                    if (partnerRecentIncomePageItemsRecordList
                                                        .isNotEmpty)
                                                      Row(
                                                        mainAxisSize:
                                                            MainAxisSize.max,
