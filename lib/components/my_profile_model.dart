...
class MyProfileModel extends FlutterFlowModel<MyProfileWidget> {
  ...
  TextEditingController? emailFieldTextController3;
  String? Function(BuildContext, String?)? emailFieldTextController3Validator;
  // State field(s) for EmailField widget.
  FocusNode? emailFieldFocusNode4;
  TextEditingController? emailFieldTextController4;
  String? Function(BuildContext, String?)? emailFieldTextController4Validator;
  // State field(s) for TextField widget.
  ...
  void dispose() {
    ...
    emailFieldTextController3?.dispose();

    emailFieldFocusNode4?.dispose();
    emailFieldTextController4?.dispose();
